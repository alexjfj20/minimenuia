...
if (!supabaseUrl || !supabaseServiceKey) {
  console.error('❌ Error: Supabase URL or SERVICE_ROLE_KEY not found.');
  process.exit(1);
}

// Client with SERVICE ROLE KEY to bypass RLS
...
async function seed() {
  console.log('🚀 Starting database seeding with SERVICE ROLE KEY...');
